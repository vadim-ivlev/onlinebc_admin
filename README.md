...
Документацию по типам данных, и возможным параметрам запросов можно получить стандартными средствами GraphQL.
...
Также функциональные тесты проводятся с помощью <https://graphql-test.now.sh/>
...
Находится в `./docs/doc/`. Доступна по <http://localhost:7777/docs/>
